...
run_iteration <- function(iter) {
  ...
  value_true <- pooled_value(as.numeric(df$policy > 0), Y1, Y0, C_id)
  ...
  unfairness_1 <- pooled_unfairness(policy, S_is_1, C_id)
  
  unfairness_2 <- pooled_unfairness(policy, S_is_2, C_id)
  
  unfairness_3 <- pooled_unfairness(policy, S_is_3, C_id)
  ...
  unfairness_1 <- pooled_unfairness(OTR_BART, S_is_1, C_id)
  
  unfairness_2 <- pooled_unfairness(OTR_BART, S_is_2, C_id)
  
  unfairness_3 <- pooled_unfairness(OTR_BART, S_is_3, C_id)
  ...
  unfairness_1 <- pooled_unfairness(cate.BART, S_is_1, C_id)
  unfairness_2 <- pooled_unfairness(cate.BART, S_is_2, C_id)
  unfairness_3 <- pooled_unfairness(cate.BART, S_is_3, C_id)
  ...
  unfairness_1 <- pooled_unfairness(OTR_cf, S_is_1, C_id)
  
  unfairness_2 <- pooled_unfairness(OTR_cf, S_is_2, C_id)
  
  unfairness_3 <- pooled_unfairness(OTR_cf, S_is_3, C_id)
  ...
  # get the CATE unfairness
  unfairness_1 <- pooled_unfairness(cate_cf_pre, S_is_1, C_id)
  unfairness_2 <- pooled_unfairness(cate_cf_pre, S_is_2, C_id)
  unfairness_3 <- pooled_unfairness(cate_cf_pre, S_is_3, C_id)
  ...
  unfairness_1_init <- pooled_unfairness(OTR_ml_fr_init, S_is_1, C_id)
  
  # condition2: E[d=1|S_is_2=1] - E[d=1|S_is_0=1]
  unfairness_2_init <- pooled_unfairness(OTR_ml_fr_init, S_is_2, C_id)
  
  # condition3: E[d=1|S_is_3=1] - E[d=1|S_is_0=1]
  unfairness_3_init <- pooled_unfairness(OTR_ml_fr_init, S_is_3, C_id)
  ...
  value_ml_fr_init_is <- pooled_value(OTR_ml_fr_init_is, Y1, Y0, C_id)
  
  # Revised the unfairness calculation for intersectional fairness
  # condition1: E[d=1|S_is_1=1] - E[d=1|S_is_1=0]
  unfairness_1_init_is <- pooled_unfairness(OTR_ml_fr_init_is, S_is_1, C_id)
  
  # condition2: E[d=1|S_is_2=1] - E[d=1|S_is_0=1]
  unfairness_2_init_is <- pooled_unfairness(OTR_ml_fr_init_is, S_is_2, C_id)
  
  # condition3: E[d=1|S_is_3=1] - E[d=1|S_is_0=1]
  unfairness_3_init_is <- pooled_unfairness(OTR_ml_fr_init_is, S_is_3, C_id)
  ...
  for (delta in delta_set) {
    ...
    unfairness_1 <- pooled_unfairness(OTR_ml_fr, S_is_1, C_id)
    
    # condition2: E[d=1|S_is_2=1] - E[d=1|S_is_0=1]
    unfairness_2 <- pooled_unfairness(OTR_ml_fr, S_is_2, C_id)
    
    # condition3: E[d=1|S_is_3=1] - E[d=1|S_is_0=1]
    unfairness_3 <- pooled_unfairness(OTR_ml_fr, S_is_3, C_id)
    ...
    # get the CATE unfairness
    unfairness_1 <- pooled_unfairness(tau_hat, S_is_1, C_id)
    unfairness_2 <- pooled_unfairness(tau_hat, S_is_2, C_id)
    unfairness_3 <- pooled_unfairness(tau_hat, S_is_3, C_id)
    ...
    value_ml_fr_is <- pooled_value(OTR_ml_fr_is, Y1, Y0, C_id)
    
    # get the Relative Utility
    RU_ml_fr_is <- (value_ml_fr_is - value_random ) / value_random
    
    # condition1: E[d=1|S_is_1=1] - E[d=1|S_is_0=1]
    unfairness_1_is <- pooled_unfairness(OTR_ml_fr_is, S_is_1, C_id)
    
    # condition2: E[d=1|S_is_2=1] - E[d=1|S_is_0=1]
    unfairness_2_is <- pooled_unfairness(OTR_ml_fr_is, S_is_2, C_id)
    
    # condition3: E[d=1|S_is_3=1] - E[d=1|S_is_0=1]
    unfairness_3_is <- pooled_unfairness(OTR_ml_fr_is, S_is_3, C_id)
    ...
    # get the CATE_MSE
    MSE_CATE_ml_fr_is <- MSE_CATE(tau_hat_is, tau, C_id)
    # get the CATE unfairness
    unfairness_1 <- pooled_unfairness(tau_hat_is, S_is_1, C_id)
    unfairness_2 <- pooled_unfairness(tau_hat_is, S_is_2, C_id)
    unfairness_3 <- pooled_unfairness(tau_hat_is, S_is_3, C_id)
...
# Now try saving your file again
